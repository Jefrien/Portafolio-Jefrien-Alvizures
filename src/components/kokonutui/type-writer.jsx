...
export default function TypewriterTitle({
    ...
    return (
        <div className="relative w-fullmx-auto">
            <div
                className="relative text-center xl:text-left z-10 flex flex-col items-center xl:items-start justify-center"
                ref={scope}>
                <motion.div
                    className="font-mono text-black dark:text-white tracking-tight flex items-center gap-2"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}>
                    <span
                        data-typewriter
